...
#
#  $ bin/test -s genweb6.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src genweb6.theme.testing.GENWEB6_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/genweb6/theme/tests/robot/test_example.robot
#
